const data = [{
	...
	git: 'https://github.com/oudeqi/oa-crm',
	desc: ['公司内部的智能办公和客户关系系统', 'vue-cli + vue@2.x + Element UI'],
	preview: null,
	cutPic: [
	...
	git: 'https://github.com/oudeqi/test-demo/tree/master/src/baidu-reg-demo',
	desc: null,
	...
	git: 'https://github.com/oudeqi/novel',
	desc: ['微信小说分销后台', 'ng1项目模板、组件化开发', 'gulp + sass + angular@1.x'],
	preview: './demo/novel/index.html',
	cutPic: [
	...
	git: null,
	desc: null,
	preview: './demo/weiguanli/login.html',
	cutPic: [
		require('../assets/images/pc44.png'),
		require('../assets/images/pc4.png')
	]
},{
	id: 5, 
	type: 0, 
	...
	git: null,
	desc: null,
	preview: './demo/weiguanli/s_user.html',
	cutPic: [
	...
	git: null,
	desc: ['图片上传', '图片裁剪', '图片预览'],
	preview: './demo/tongxingz/head-setting.html',
	cutPic: [
	...
	git: 'https://github.com/oudeqi/test-demo/tree/master/src/css3-3d-demo',
	desc: null,
	...
	git: 'https://github.com/oudeqi/test-demo/tree/master/src/input-demo',
	desc: null,
	...
	type: 1, 
	name: '图片滑动组件练习',
	cover: require('../assets/images/yd1.png'),
	git: 'https://github.com/oudeqi/test-demo/tree/master/src/mobile-swiper-demo',
	desc: ['移动端图片滑动组件', '请用手机扫描二维码查看'],
	preview: './demo/test-demo/mobile-swiper-demo.html',
	cutPic: [
		require('../assets/images/tupianhuadong.png'),
	...
	git: 'https://github.com/oudeqi/shopping-mall',
	...
	cutPic: [
		...
		require('../assets/images/shopping-mall-1.png')
	]
},{
	id: 13, 
	type: 1, 
	name: '手机页面',
	cover: require('../assets/images/yd4.png'),
	git: 'https://github.com/oudeqi/oa-crm',
	desc: ['智能办公和客户关系系统', 'vue-cli + vue@2.x'],
	preview: '',
	cutPic: [
		require('../assets/images/mtxx08.jpg'), 
		require('../assets/images/mtxx09.jpg'),
		require('../assets/images/mtxx12.jpg')
	]
},{
	id: 14, 
	type: 1, 
	name: 'bootstrap练习',
	cover: require('../assets/images/yd9.png'),
	git: null,
	desc: null,
	preview: './demo/tuanwei/index.html',
	cutPic: [
		require('../assets/images/tupianhuadong.png'),
		require('../assets/images/yd99.png')
	]
}];
export default data;